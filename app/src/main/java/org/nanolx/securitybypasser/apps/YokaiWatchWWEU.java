 ...
 */
public class YokaiWatchWWEU implements IXposedHookLoadPackage
{
	@Override
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam param) throws Throwable
	{
		XposedBridge.log("Nanolx Security Bypasser: Entering Yokai Watch Wibble Wobble (EU)... Ready... Set... GO!");
